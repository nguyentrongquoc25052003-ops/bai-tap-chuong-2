...
<header>
    ...
    <nav>
        ...
        <a href="<?php echo e(route('projects')); ?>" class="<?php echo e(request()->routeIs('projects') ? 'active' : ''); ?>">Dự án</a>
        <a href="<?php echo e(route('contact')); ?>" class="<?php echo e(request()->routeIs('contact') ? 'active' : ''); ?>">Liên hệ</a>
    </nav>
</header>
...
</html><?php /**PATH E:\laragon\www\bt2.1\resources\views/layouts/master.blade.php ENDPATH**/ ?>